...
export class MovieService {
  static getMovies(): MovieModel[] {
    ...
    static getMovieList(): MovieModel[] {
      return this.getMovies()
    }

    static getGenres(): { id: number, name: string }[] {
      return [
        { id: 1, name: 'Sci-Fi' },
        { id: 2, name: 'Adventure' },
        { id: 3, name: 'Action' },
